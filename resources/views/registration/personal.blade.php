...
@section('content')
{!! Form::open(['url' => route('register.personal.post'), 'method' => 'POST', 'class' => 'form-signin']) !!}
  ...
  <div class="form-label-group">
    {!! Form::plainInput('email', 'email', null, ['id' => 'inputEmail', 'placeholder' => 'Email address', 'autofocus' => true, 'class' => appendToStringWhen($errors->has('email'), 'form-control', ' is-invalid')]) !!}
  ...
  <div class="form-label-group">
    {!! Form::plainInput('text', 'name', null, ['id' => 'inputName', 'placeholder' => 'Full Name', 'class' => appendToStringWhen($errors->has('name'), 'form-control', ' is-invalid')]) !!}
